...
/**
 * Stash Typography — uses the system default font (Roboto on most Android
 * devices) for a clean, native feel that blends seamlessly with the OS.
 *
 * Previously used SpaceGrotesk for display/headline/title and Inter for
 * body/label. Switched to system default per user preference.
 */
